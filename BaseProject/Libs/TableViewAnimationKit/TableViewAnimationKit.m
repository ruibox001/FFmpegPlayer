...
+ (void)moveAnimationWithTableView:(UITableView *)tableView {
    ...
    for (int i = 0; i < cells.count; i++) {
        ...
        [UIView animateWithDuration:0.4 delay:i*(totalTime/cells.count) usingSpringWithDamping:1.7 initialSpringVelocity:1/1.7 options:UIViewAnimationOptionCurveEaseIn animations:^{
